...
export const satelliteWorldCities = [
  ...
  { name: "Kyoto", lat: 35.0394, lng: 135.7292, country: "Japan", region: "Asia", funFact: "Once the imperial capital for over a thousand years, home to more UNESCO World Heritage temples than any other city in its country.", imageFile: "Kyoto_Japan.jpg" }, // Kinkaku-ji is not identifiable from directly overhead; the frame reads as the city grid + western hills instead. Needs a different landmark, which needs a re-fetch.
  { name: "Seoul", lat: 37.5200, lng: 126.9920, country: "South Korea", region: "Asia", funFact: "A major river splits this capital into northern and southern halves, with mountains ringing the city.", imageFile: "Seoul_South_Korea.jpg" },
  ...
  { name: "Munich", lat: 48.1374, lng: 11.5755, country: "Germany", region: "Europe", funFact: "Host to the world's largest beer festival every autumn.", imageFile: "Munich_Germany.jpg" },
  ...
  { name: "Vienna", lat: 48.2082, lng: 16.3650, country: "Austria", region: "Europe", funFact: "Once the imperial capital of a major European dynasty, famous for its classical music tradition.", imageFile: "Vienna_Austria.jpg" },
  ...
  { name: "Reykjavik", lat: 64.1466, lng: -21.9426, country: "Iceland", region: "Europe", funFact: "One of the northernmost capitals of any sovereign country, heated almost entirely by geothermal energy.", imageFile: "Reykjavik_Iceland.jpg" },
  ...
  { name: "Havana", lat: 23.1450, lng: -82.3700, country: "Cuba", region: "North America", funFact: "A seaside city famous for its colorful vintage cars and colonial architecture.", imageFile: "Havana_Cuba.jpg" }, // image is a 860px crop of the 1280px original, see the Satellite Imagery notes
  { name: "Panama City", lat: 8.9430, lng: -79.5560, country: "Panama", region: "North America", funFact: "Located right beside a canal that connects the Pacific and Atlantic Oceans.", imageFile: "Panama_City_Panama.jpg" },
  ...
  { name: "São Paulo", lat: -23.5505, lng: -46.6333, country: "Brazil", region: "South America", funFact: "The most populous city in the Southern Hemisphere, known for its dense high rise skyline.", imageFile: "Sao_Paulo_Brazil.jpg" },
  ...
  { name: "Santiago", lat: -33.4489, lng: -70.6300, country: "Chile", region: "South America", funFact: "A city at the foot of a famous mountain range, with snow capped peaks visible most of the year.", imageFile: "Santiago_Chile.jpg" },
  ...
  { name: "La Paz", lat: -16.5000, lng: -68.1336, country: "Bolivia", region: "South America", funFact: "The highest administrative capital in the world, built inside a massive valley basin.", imageFile: "La_Paz_Bolivia.jpg" },
  ...
  { name: "Nairobi", lat: -1.3580, lng: 36.8400, country: "Kenya", region: "Africa", funFact: "One of the few capital cities in the world with a wildlife national park right at its edge.", imageFile: "Nairobi_Kenya.jpg" }, // image is a 860px crop of the 1280px original, see the Satellite Imagery notes
  { name: "Zanzibar", lat: -6.1620, lng: 39.1885, country: "Tanzania", region: "Africa", funFact: "An old town on an Indian Ocean island that was once the center of the East African spice trade.", imageFile: "Zanzibar_Tanzania.jpg" },
  { name: "Lagos", lat: 6.4480, lng: 3.4060, country: "Nigeria", region: "Africa", funFact: "One of the most populous cities in Africa, built across a lagoon.", imageFile: "Lagos_Nigeria.jpg" },
  ...
  { name: "Wellington", lat: -41.2865, lng: 174.7762, country: "New Zealand", region: "Oceania", funFact: "The southernmost national capital in the world, known for being very windy.", imageFile: "Wellington_New_Zealand.jpg" },
  { name: "Gold Coast", lat: -28.0023, lng: 153.4300, country: "Australia", region: "Oceania", funFact: "Famous for its long stretch of surf beaches, one of the most popular vacation destinations in its country.", imageFile: "Gold_Coast_Australia.jpg" },
  { name: "Nadi", lat: -17.7730, lng: 177.3770, country: "Fiji", region: "Oceania", funFact: "An island nation in the South Pacific known for its coral reefs and resorts.", imageFile: "Nadi_Fiji.jpg" },
];
